...
public class ResultActivity extends AppCompatActivity {
    ...
    private TextView fuelSavingTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ethanolPriceTextView = findViewById(R.id.gas_milage_result);
        ...
        fuelSavingTextView = findViewById(R.id.fuel_saving);
        ...
        ethanolSpentTextView.setText(String.valueOf(ethanolSpent));
        gasSpentTextView.setText(String.valueOf(gasSpent));
        rateTextView.setText(String.format("%.2f %%", rateFuel));
        fuelSavingTextView.setText("Economia de " + nf.format(fuelSaving));
